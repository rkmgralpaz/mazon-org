    ...
    <main class="module module-previous-items archive">
        <div class="outer max-width">
            <div class="inner site-padding-2">
                <h2 class="label">Publications Archive</h2>
                <?php
                ...
                ?>
                    ...
                    $href = get_field('real3d_flipbook_view') ? get_permalink() : $pdf_file['url'];
                    $target = get_field('real3d_flipbook_view') ? '_self' : '_blank';

                    ?>
                    <div class="post-item">
                      <a href="<?php echo $href; ?>" target="<?php echo $target; ?>"><?php echo get_the_title(); ?><span class="date"><?php echo get_the_date(); ?></span>
                      </a>
                    </div>
                <?php
