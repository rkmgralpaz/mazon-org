...
function my_toolbars( $toolbars ){
	...
	$toolbars['Super Basic'][1] = array('bold','italic','underline','pastetext','removeformat','fullscreen','wp_adv');
	
	$toolbars['Basic'] = array();
	$toolbars['Basic'][1] = array('bold','italic','underline','link','unlink','pastetext','removeformat','fullscreen','wp_adv');
	
    $toolbars['Basic And Styles'] = array();
	$toolbars['Basic And Styles'][1] = array('styleselect','bold','italic','underline','link','unlink','pastetext','removeformat','fullscreen','wp_adv');

	$toolbars['Basic And Bullist'] = array();
	$toolbars['Basic And Bullist'][1] = array('bold','italic','underline','bullist','numlist','link','unlink','pastetext','removeformat','fullscreen','wp_adv');
    
    $toolbars['Basic Indent'] = array();
	$toolbars['Basic Indent'][1] = array('bold','italic','underline','bullist','numlist','outdent','indent','link','unlink','pastetext','removeformat','fullscreen','wp_adv');
	
	$toolbars['Advanced'] = array();
	$toolbars['Advanced'][1] = array('styleselect','formatselect','bold','italic','underline','link','unlink','pastetext','removeformat','fullscreen','wp_adv');
    
    $toolbars['Styles And Link'] = array();
	$toolbars['Styles And Link'][1] = array('styleselect','link','unlink','pastetext','removeformat','fullscreen','wp_adv');
	
    $toolbars['Styles And Link And Italic'] = array();
	$toolbars['Styles And Link And Italic'][1] = array('styleselect','italic','link','unlink','pastetext','removeformat','fullscreen','wp_adv');

	$toolbars['Full'] = array();
	$toolbars['Full'][1] = array('styleselect','formatselect','bold','italic','underline','bullist','numlist','link','unlink','pastetext','removeformat','table','outdent', 'indent', 'undo', 'redo','fullscreen','wp_adv');
    
    $toolbars['Link Only'] = array();
	$toolbars['Link Only'][1] = array('link','unlink','pastetext','fullscreen','wp_adv');

    $toolbars['Italic Only'] = array();
	$toolbars['Italic Only'][1] = array('italic','pastetext','removeformat','fullscreen','wp_adv');
    
    $toolbars['Formats Only'] = array();
	$toolbars['Formats Only'][1] = array('styleselect','pastetext','removeformat','fullscreen','wp_adv');
...
function my_admin_enqueue_scripts() {
	wp_enqueue_script( 'my-admin-js', get_template_directory_uri() . '/js/acf-custom-events.js', array(), '1.0.110', true );
}
...
function on__style(){
	...
	wp_enqueue_style('style-theme', get_bloginfo('stylesheet_url'), false, '1.0.110', 'screen');
}
...
function my_scripts() {
	...
	wp_register_script( 'main-script', get_template_directory_uri() . '/js/main.min.js', array( 'jquery'), '1.0.110', false);
