<?php
/**
 * Template Name: Postcards — Wall
 * Description: Página que embebe el postcards wall en un iframe.
 */
...
">
  <iframe
    ...
    src="<?php echo get_template_directory_uri(); ?>/postcards-wall/index.html"
    width="100%"
    style="
      display: block;
      width: 100%;
