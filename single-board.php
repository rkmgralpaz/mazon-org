<?php get_header(); ?>
            ...
            $post_id = 125;//get_page(125);
            $ancestors = get_post_ancestors(125);
            ...
            if(count($prev_page)):
                $back_url = get_permalink($prev_page[0]->ID);                
            else:
            ...
            <main class="max-width">
                <div class="site-padding-2">
                    ...
                    <div class="staff-board-post-content">
                        <div class="left">
                            ...
                            <div class="g-1">                        
                                <div class="author">
                                    ...
                                    ?>
                                    <?php if($info['email'] != ""){ ?>
                                    <a href="mailto:<?php echo $info['email']; ?>">Email</a><br>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="g-2">
                                ...
                                <div class="icons">
                                    ...
                                    <a class="twitter" href="<?php echo get_twitter_share_url(); ?>" target="_blank">
                                        <span>Twitter</span>
                        ...
                        <div class="right">
                            ...
                            <div class="image-wrapper">
                                <div class="image">
                                    <div class="img" style="background-image: url(<?php echo $thumbnail['image']['url'] ?> );"></div>
                                </div>
                            </div>
                            <?php
                            endif;
                            ?>
                            <div class="text"><?php echo get_field('bio'); ?></div>
                        </div>
                    </div>
