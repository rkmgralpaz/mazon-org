                            ...
                            <div class="main-video">
                                <div class="video-wrapper">
                                    ...
                                    if(!$video_image):
                                        ...
                                        $video_image = $excerpt_content['thumbnail']['image'];
                                    endif;
                                    ?>
                                    <div class="video" style="background-image:url(<?php echo $video_image['url']; ?>)"></div>
                                    <a class="video-button" href="<?php echo get_field('video_url'); ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10.176" height="13" viewBox="0 0 10.176 13">
                                            <path d="M6.5,0,13,10.176H0Z" transform="translate(10.176) rotate(90)" fill="#fff"></path>
                                        </svg>
                                        <?php if(get_field('video_duration') != ''): ?>
                                        <div class="time"><?php echo get_field('video_duration'); ?></div>
                                        <?php endif; ?>
                                    </a>
                                </div>
                            </div>
